...
## Why
Mainly as an exercise, but i also tried to implement things i could not find in other libraries: DMA, ping-pong double buffering, a fast algo to draw sprites
