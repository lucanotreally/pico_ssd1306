...
- **Use of Direct Memory Access**: you can decide to use dma or the pico HAL to send the data to the display, dma usage allows you to bypass the serial communication bottleneck !!WIP!!
